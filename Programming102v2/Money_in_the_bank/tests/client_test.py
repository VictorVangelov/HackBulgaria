...
class ClientTests(unittest.TestCase):
    ...
    def setUp(self):
        self.test_client = Client(1, "Ivo", 200000.00, "Bitcoin mining makes me rich", "victor.vangelov@gmail.com")
    ...
    def test_client_email(self):
        self.assertEqual(self.test_client.get_email(), "victor.vangelov@gmail.com")
